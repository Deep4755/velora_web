...
const allProjects = [
  ...
  { id: 7, title: "Coffee Shop Store", category: "Ecommerce", tag: "ecommerce", gradient: "from-orange-50 to-amber-100", liveUrl: null },
  { id: 8, title: "Yoga Studio", category: "Business Website", tag: "business", gradient: "from-purple-50 to-violet-100", liveUrl: null },
  { id: 9, title: "Tech Startup", category: "Landing Page", tag: "landing", gradient: "from-cyan-50 to-sky-100", liveUrl: null },
  { id: 10, title: "Jewellery Store", category: "Ecommerce", tag: "ecommerce", gradient: "from-pink-50 to-rose-100", liveUrl: null },
  { id: 11, title: "Law Firm", category: "Business Website", tag: "business", gradient: "from-slate-50 to-gray-100", liveUrl: null },
  { id: 12, title: "Pet Shop", category: "Ecommerce", tag: "ecommerce", gradient: "from-lime-50 to-green-100", liveUrl: null },
];

const caseStudies = [
  {
    title: "Local Carpet Fitter — Business Website",
    result: "Professional online presence with improved local SEO and customer enquiries",
    challenge: "A local carpet fitting service needed a professional website to compete with larger companies and attract more local customers.",
    solution: "We built a clean, responsive business website with clear service pages, a contact form, and local SEO optimisation to help them rank in their area.",
    icon: "🏠",
    gradient: "from-amber-50 to-orange-100",
  },
  {
    title: "QuickBreak — Web Application MVP",
    result: "MVP launched helping users find nearby stations with details not available on any map",
    challenge: "An innovative idea to help drivers find nearby service stations with real-time data and route preferences — but no existing solution covered this properly.",
    solution: "Built a full-stack MERN application with API integration for location-based services, real-time data and an intuitive user interface.",
    icon: "📍",
    gradient: "from-emerald-50 to-teal-100",
  },
  {
    title: "Developer Portfolio — Personal Brand",
    result: "Professional portfolio showcasing full-stack development skills and live projects",
    challenge: "Needed a modern, dark-themed portfolio to showcase development work and attract freelance clients.",
    solution: "Designed and built a sleek portfolio with project showcases, live links, tech stack badges and a clean contact section.",
    icon: "💻",
