                ...
                <>
                  ...
                  <form onSubmit={submit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label className="text-sm font-semibold text-[#111111] block mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label className="text-sm font-semibold text-[#111111] block mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Phone</label>
                        <input type="tel" name="phone" value={form.phone} onChange={handle} placeholder="+44 ..." className="input-field" />
                      </div>
                      <div>
                        <label className="text-sm font-semibold text-[#111111] block mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Company</label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label className="text-sm font-semibold text-[#111111] block mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Budget</label>
                      ...
                      <div>
                        <label className="text-sm font-semibold text-[#111111] block mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Timeline</label>
            ...
            <div className="lg:col-span-2 flex flex-col gap-5">
              {[
                ...
                <div key={i} className="bg-white rounded-2xl p-6 border border-gray-200 flex items-start gap-5 shadow-sm card-hover">
                  ...
                  <div>
                    <p className="font-semibold text-base text-[#111111] mb-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{info.label}</p>
                    {info.href
              ...
              <div className="rounded-2xl p-6" style={{ background: "linear-gradient(135deg, #4F46E5, #6366f1)" }}>
                <p className="font-semibold text-base text-white mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>⚡ Quick Response</p>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                <p className="font-semibold text-base text-[#111111] mb-5" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>What Happens Next?</p>
